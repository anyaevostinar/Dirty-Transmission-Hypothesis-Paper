...
#first_try <-read.table("munged_histogram_sym_vt02.dat", h=T)
#first_try <- read.table("munged_histogram_host.dat", h=T)
...
breakout <- subset(combined, treatment == "HMR1.0VR0.3")
