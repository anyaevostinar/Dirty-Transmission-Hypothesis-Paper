...
#Assumes that SymSettings.cfg with the appropriate base settings is already in the data folder and symbulation_efficient
import sys

h_mut_rates = [0.95, 0.9]
...
for a in seeds:
    for b in h_mut_rates:
        for c in vert_rates:
            ...
            command_str = './symbulation_efficient -SEED '+str(a)+  ' -HORIZ_MUTATION_RATE '+str(b) + ' -VERTICAL_TRANSMISSION '+str(c) + ' -FILE_NAME '+ file_name     
